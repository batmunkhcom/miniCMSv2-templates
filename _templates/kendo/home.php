...
<div id="apuContent">
        ...
        <?
				...
				if($DB->mbm_num_rows($r_highlights) == 1){
					...
					echo '<div style="text-align:right;">
							<a href="index.php?module=apu&cmd=content&menu_id='.mbmReturnMenuId($DB->mbm_result($r_highlights,0,"menu_id")).'&id='.$DB->mbm_result($r_highlights,0,"id").'">
    ...
    <div style="
        ...
        <br clear="all" />
        <div style="padding-top:8px; padding-bottom:8px; text-align:right; display:none;">
        	<a href="index.php?module=menu&cmd=content&menu_id=<?=mbmShowByLang(array('mn'=>24,'en'=>70))?>">
            	<img src="templates/apu/images/presscenter_en.gif" border="0" />
            </a>
        </div>
    </div>
    <br clear="all" />
