      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="0">
        <tr>
          <td width="50%" valign="top" style="border:1px solid #DDD;">
              ...
              <div style="padding:5px;"><?= mbmContentNews($GLOBALS['htmls_normal'],mbmShowByLang(array('mn'=>392,'en'=>888888)),2,2,'date_added','desc',0,1)?></div></td>
        ...
        <tr>
          ...
          <td valign="top" style="border:1px solid #DDD;"><?=mbmShowBanner('home_3')?>
          </td>
        </tr>
        <tr>
          <td valign="top" height="8"></td>
